...
//		Mylogin.LogOut();
	...
	public void moveToLearnerModule() throws InterruptedException {
		...
		try{
			if(MyLearnerModule.MoveToLearnerModule()){
	...
	public void ActivateCourseOperations() throws InterruptedException {
	...
	public void DeleteCourseOperations(Map<String,String>data) throws InterruptedException {
		try{
			if(MyCourseCreation.DeleteCourse(data.get("DeleteCourseOperations"))){
