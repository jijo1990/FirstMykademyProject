...
public class RoleManagement extends DriverFactory {
    ...
    @FindBy(xpath = ".//a[@class='text-capitalize' and contains(text(),'New Test Role29')]//ancestor::div[@class='rTableRow']//following-sibling::span[@class='dropdown-tigger']")
    private WebElement roleDropdownArrow;

    @FindBy(xpath = ".//a[@class='text-capitalize' and contains(text(),'New Test Role29')]//ancestor::div[@class='rTableRow']//following-sibling::ul[@class='dropdown-menu pull-right']//a[contains(text(),'Delete')]")
    private WebElement deleteRoleOption;

    @FindBy(xpath = ".//a[@class='text-capitalize' and contains(text(),'New Test Role29')]//ancestor::div[@class='rTableRow']//following-sibling::a[contains(text(),'Restore')]")
