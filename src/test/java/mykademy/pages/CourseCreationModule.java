...
public class CourseCreationModule extends DriverFactory {
    ...
    @FindBy(xpath = ".//a[text()='Activate']")
    private WebElement activateCourseOption;
...
//    ActivateCourse
    ...
    @FindBy(xpath = ".//ol[@class='nav offa-tab custom-sidemenu']//li//a[contains(text(),'COURSE CONTENT')]")
    private WebElement moveToCourseContentPageFromSettings;
...
//        cropImage.click();
    ...
    public boolean ActivateNewCourse() throws InterruptedException {
    		...
    		moveToCourseContentPageFromSettings.click();
	        selectDropdownOfSection.click();
	        selectActivateAllOption.click();
	        confirmationPopUpOkBtn.click();
	        Thread.sleep(300);
	        confirmationPopUpOkBtn.click();
	        courseActivateOptionOfCourseContent.click();
	        activateCourseOption.click();
    ...
    @Parameters({"DeleteCourseOperations"})
    @Test(priority = 13)
    public boolean DeleteCourse(String DeleteCourseOperationsFld) throws InterruptedException {

        searchCourseName.sendKeys(DeleteCourseOperationsFld);
        Thread.sleep(1000);
